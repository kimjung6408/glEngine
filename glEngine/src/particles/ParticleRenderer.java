...
public class ParticleRenderer {
	...
	//행렬 16개 float , texOffsets 4개 float,  blend factor 1개 float
	//다 합쳐서 21개. 즉, 21개 float는 instance마다 바뀐다.
	...
	private void bindTexture(ParticleTexture texture)
	{
		...
		SelectBlendingFunction(texture.isAdditiveBlending());
	}
	...
	private void DoAlphaBlending(boolean doAlphaBlend)
	{
		if(doAlphaBlend)
		{
	...
	private void SelectBlendingFunction(boolean isAdditive)
	{
		if(isAdditive)
		{
