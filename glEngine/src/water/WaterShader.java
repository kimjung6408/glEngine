...
public class WaterShader extends ShaderProgram {
	...
	public void loadViewMatrix(Camera camera){
		...
		super.loadVector3(location_cameraPosition, camera.getPosition());
	}
	...
	{
		super.loadVector3(location_lightPosition, sun.getPosition());
		super.loadVector3(location_lightColor, sun.getColor());
	}
}
